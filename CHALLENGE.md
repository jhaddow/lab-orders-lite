...
You’ll build a small app. You are free to use any technology stack you prefer. For context, our team uses **Next.js**, **TypeScript**, **Shadcn**, **Prisma**, and **PostgreSQL**. We’ll then meet in person to discuss your choices and extend the app together.  
